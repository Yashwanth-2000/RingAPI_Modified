...
public class RingPolicy_BC1_Scripts  {
	...
	@Test(priority = 0)
	public void RingPolicy_BC1() throws Exception {
		...
		ExtentReporter.HeaderChildNode("RegularOffer_BC1 (testing-service)");
		...
		ExtentReporter.HeaderChildNode("RegularOffer_BC1_DataBase (testing-service)");
