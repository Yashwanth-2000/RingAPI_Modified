...
public class RegisterUser_Get_Details_VPA {
	...
	RingPay_TestData_DataProvider_L1 dataProvider = new RingPay_TestData_DataProvider_L1();
...
//		Start Time
		...
		ValidatableResponse response = Utilities.Get_Details_VPA_API_RingPolicy_L1(data);
