package com.business.RingPay_RingPolicy_L1;
...
public class RegisterUser_UserAuthenticate {
	...
	public static ValidatableResponse userToken_Positive() throws Exception {
		...
		ValidatableResponse response = Utilities.userTokenAPI_Positive_L1(data);
...
//	L1
	public static ValidatableResponse userToken_Repeat_L1() throws Exception {
		...
		Object[][] data = dataProvider.UserAuthenticateAPIData("auth_200");
		ValidatableResponse response = Utilities.userTokenAPI_Repeat_L1(data);
