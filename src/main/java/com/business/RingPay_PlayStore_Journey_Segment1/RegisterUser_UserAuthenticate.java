...
public class RegisterUser_UserAuthenticate {
	...
	public static ValidatableResponse userToken_Positive() throws Exception {
		...
		ValidatableResponse response = Utilities.userTokenAPI_PlayStore_S1(data);
	...
	public static ValidatableResponse userToken_Positive_PlayStore_Repeat_S1() throws Exception {
		...
		Object[][] data = RingPay_TestData_DataProvider.UserAuthenticateAPIData("segment1_auth_200");
		ValidatableResponse response = Utilities.userTokenAPI_Repeat_PlayStore_S1(data);
