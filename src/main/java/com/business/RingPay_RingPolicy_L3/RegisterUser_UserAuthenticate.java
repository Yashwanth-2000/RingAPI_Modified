...
public class RegisterUser_UserAuthenticate {
	...
	public static ValidatableResponse userToken_Positive() throws Exception {
		...
		ValidatableResponse response = Utilities.userTokenAPI_Positive_L3(data);
...
//	L2
	public static ValidatableResponse userTokenAPI_Repeat_L3() throws Exception {
		...
		Object[][] data = dataProvider.UserAuthenticateAPIData("auth_200");
		ValidatableResponse response = Utilities.userTokenAPI_Repeat_L3(data);
