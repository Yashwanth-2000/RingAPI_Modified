package com.business.RingPay_RingPolicy_LTBC1;
...
public class RegisterUser_Get_Details_VPA {
	...
	RingPay_TestData_DataProvider_LTBC1 dataProvider = new RingPay_TestData_DataProvider_LTBC1();
...
//		Start Time
		...
		ValidatableResponse response = Utilities.Get_Details_VPA_API_RingPolicy_LTBC1(data);
