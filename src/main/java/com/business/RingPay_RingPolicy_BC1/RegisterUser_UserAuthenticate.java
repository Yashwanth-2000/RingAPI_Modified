...
public class RegisterUser_UserAuthenticate {
	...
	static	RingPay_TestData_DataProvider_BC1 dataProvider = new RingPay_TestData_DataProvider_BC1();
	...
	public static ValidatableResponse userToken_Positive() throws Exception {
		...
		ValidatableResponse response = Utilities.userTokenAPI_Positive_BC1(data);
...
//	BC1
	public static ValidatableResponse userToken_Repeat_BC1() throws Exception {
		...
		Object[][] data = dataProvider.UserAuthenticateAPIData("auth_200");
		ValidatableResponse response = Utilities.userTokenAPI_Repeat_BC1(data);
