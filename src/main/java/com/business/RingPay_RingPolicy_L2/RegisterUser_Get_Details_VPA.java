...
public class RegisterUser_Get_Details_VPA {
	...
	RingPay_TestData_DataProvider_L2 dataProvider = new RingPay_TestData_DataProvider_L2();
...
//		Start Time
		...
		ValidatableResponse response = Utilities.Get_Details_VPA_API_RingPolicy_L2(data);
