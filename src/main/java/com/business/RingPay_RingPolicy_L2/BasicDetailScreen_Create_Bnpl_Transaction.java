...
public class BasicDetailScreen_Create_Bnpl_Transaction {
	...
	public static ValidatableResponse getApplicationToken_Positive() throws Exception {
		...
		ValidatableResponse response = Utilities.Merchant_Create_Bnpl_TransactionAPI_L2(data);
	...
	public static ValidatableResponse getApplicationToken_Positive_Repeat() throws Exception {

		//		Start Time
		long startTime=System.currentTimeMillis();

		Object[][] data = dataProvider.CreateBnplTransactionAPIData("bnpl_200");
		ValidatableResponse response = Utilities.Merchant_Create_Bnpl_TransactionAPI_L2_Token(data);
