...
public class OfferDetailsScreen_Check_Application_Eligibility {
	...
	public void OfferDetailsScreen_CheckApplicationEligibility_Positive() throws Exception {
		...
		Validation.assertEquals(response.extract().body().jsonPath().get("data.segment"),"SEGMENT_1","OfferDetailsScreen_CheckApplicationEligibility_Positive,Validating segment should be SEGMENT_1");
